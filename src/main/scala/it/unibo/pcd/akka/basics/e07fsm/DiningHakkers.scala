...
object Chopstick:
  ...
  enum ChopstickMessage:
    case Take(ref: ActorRef[ChopstickAnswer])
    case Put(ref: ActorRef[ChopstickAnswer])
  export ChopstickMessage.*
  enum ChopstickAnswer:
    case Taken(chopstick: ActorRef[ChopstickMessage])
    case Busy(chopstick: ActorRef[ChopstickMessage])
  export ChopstickAnswer.*
...
object Hakker:
  enum Command:
    case Think
    case Eat
    case HandleChopstickAnswer(msg: ChopstickAnswer)
  export Command.*
